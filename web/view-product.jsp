                 ...
                 <div class="container-fluid p-0 admin-header" style="margin-left:17.8rem">
                     ...
                     <div class="show-products">
                      ...
                      <tr>
                          ...
                          <td>
                               <a href="edit-product.jsp?id=<%= rs.getInt(1) %>"><i class="fas fa-edit pe-3 fs-5"></i></a>
                              <a href="deleteproduct?id=<%=rs.getInt(1)%>"><i class="fa fa-trash pe-3 fs-5"></i></a></td>
                      </tr>
                      <%
                          }
                          }
